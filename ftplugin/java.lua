    ...
    java = {
      ...
      configuration = {
        ...
        runtimes = {
          ...
          {
            name = 'JavaSE-11',
            path = '/Users/somsinha/.sdkman/candidates/java/11.0.22-amzn',
          },
          {
            name = 'JavaSE-21',
            path = '/Users/somsinha/.sdkman/candidates/java/21.0.3-amzn',
          },
        },
      },
      maven = {
...
config['on_attach'] = function(client, bufnr)
  ...
  table.insert(dap.configurations.java, {
    ...
    javaExec = '/Users/somsinha/.sdkman/candidates/java/17.0.9-amzn/bin/java',
